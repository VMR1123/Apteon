...
public class HardPlusFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ArrayList<Score> top5 = dbh.getTop5EncryptedScores(8);
        ArrayList<Score> last5 = dbh.getLast5EncryptedScores(8);
        ...
        totalscore = dbh.getTotalScore(8) + " Pts";
        if (dbh.getTotalScore(8) == null)
            totalscore = 0 + " Pts";

        textView1.setText(totalscore);

        String avgAccuracy;
        avgAccuracy = dbh.getAverageAccuracy(8) + " Pts";

        if (dbh.getAverageAccuracy(8) == null)
            avgAccuracy = 0 + " Pts";
